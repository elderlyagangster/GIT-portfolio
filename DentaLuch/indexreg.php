  ...
  <body>
    ...
    <?php if ( isset($_SESSION['logged_user']) ) : ?>
        <div class="container" style="margin-top: 5%; margin-bottom: 5%;">
          <h1><?php echo $_SESSION['logged_user']->name; ?> <?php echo $_SESSION['logged_user']->lastname; ?></h1>
          <strong>E-mail</strong> <?php echo $_SESSION['logged_user']->email; ?><br><strong>Тел.:</strong> <?php echo $_SESSION['logged_user']->num; ?><br>
          <hr>
          <a class="btn btn-secondary" href="logout.php">Выйти</a>
        </div>
    <?php else : ?>
    <div class="reg">
    <a class="btn btn-secondary" href="login.php">Авторизация</a><br>
    <a class="btn btn-secondary" href="singup.php">Регистрация</a>
    </div>
    <?php endif; ?>
    </div>
    <style>
